...
/**
 Custom Exception Handler For [UserResource] and all Classes that it calls and sends HTTP_Response with and Exception
 */
@RestControllerAdvice
@Slf4j
public class HandleException
        extends ResponseEntityExceptionHandler
        implements ErrorController // If user goes to the webpage that doesn't exist, he will not have a white page. Also, you need to do something [application-dev.yaml] for it to work. (and, we can create our custom page for that) --v
{
    @Override
                                                             ...
                                                             )
    {
        ...
        return new ResponseEntity<> (
                HttpResponse.builder ()
                            ...
                            .reason (exception.getMessage ()) // You need to replace it by your text in every place there
    ...
    */
    ...
    public ResponseEntity<HttpResponse> sQLIntegrityConstraintViolationException (SQLIntegrityConstraintViolationException exception)
    {
        ...
        return new ResponseEntity<> (
                HttpResponse.builder ()
                            .timeStamp (now ().toString ())
                            .reason (exception.getMessage ().contains ("Duplicate entry") ?
    ...
    private ResponseEntity<HttpResponse> createErrorHttpResponse (HttpStatus httpStatus,
                                                                  String reason,
                                                                  Exception exception
                                                                 )
    {
